...
export class Globals {
  ...
  top10ClientesSumaPorMes: any = [
    ...
    },
    {
      ...
      TotalBCICMSST: 0.00,
      TotalICMSST: 0.00,
      Client: new Client(1, 'LM2t Gastronomia E Servs Ltda', '', true, 1, '', new Array<ExtratoTotal>()),
      Clients: new Array<Client>()
    },
    {
      MesAnoEmit: '09/18',
...
//en array clients guardar: 24 meses de extratos por mes por cliente y guardar top 5 clientes de la empresa por año?
